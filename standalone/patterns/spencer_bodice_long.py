#!/usr/bin/env python
# patternName: Spencer_Bodice_Long
# patternNumber: W_Block
...
class Design(designBase):
    ...
    def pattern(self):
        ...
        pth = (['M', c5, 'C', c9, 'C', c10, 'C', c11, 'C', c1, 'C', c14, 'C', c13, 'C', c12, 'C', c7, 'C', c23, 'C', c16, 'C', c25, 'L', c15, 'C', cD1.o, 'L', cD1.m, 'L', cD1.i, 'C', c5])
        C.addSeamLine(pth)
