...
class Design(designBase):
    ...
    def pattern(self) :
        ...
        FAP = A.addPoint('FAP', polar(FAP2, side_ease, angleOfLine(FBP, FBS))) #front armscye point - incl. side ease parallel to bustline
        FUS2 = A.addPoint('FUS2', intersectLines(FUS3, FBS, FUC, FUS4)) # front underarm side 2 - parallel to underarmline
        FUS = A.addPoint('FUS', polar(FUS2, side_ease, angleOfLine(FUC, FUS4))) # front underarm side - incl. side ease parallel to underarmline
        ...
        FWS = A.addPoint('FWS', polar(FWS2, side_ease, angleOfLine(FUC, FUS4))) #front waist side - incl. side_ease parallel to underarmline
